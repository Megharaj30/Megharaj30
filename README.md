...
<p align="center">
  ML & Backend Engineering · Building Production-Ready Systems
</p>
...
- Focused on **machine learning and backend engineering**
- Build systems that go from **data → API → real users**
- Comfortable with **model training, deployment, and integration**
- Bias toward **shipping, iteration, and clean system design**
...
- **Blood Donation Management System**  
  ...
  Real-time platform for donor–recipient matching with admin control  

- **Carbon Footprint Calculator**  
  `PHP · MySQL · HTML/CSS`  
  Web app to estimate carbon footprint and encourage sustainable choices  

- **Flight Price Predictor**  
  `Python · Flask · Machine Learning`  
  End-to-end ML pipeline for predicting flight prices on large datasets  
...
<sub>Actively building and open to ML & Backend engineering opportunities.</sub>
